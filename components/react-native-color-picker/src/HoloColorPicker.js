    ...
    return (
      <View style={style}>
        ...
        { this.props.hideSliders == true ? null :
          <View>
            <Text style={{marginLeft: 15}}>White Range</Text>
            <Slider style={{marginTop: 10}} value={s} onValueChange={this._onSValueChange} />
            <Text style={{marginLeft: 15, marginTop: 15}}>Brightness</Text>
            <Slider style={{marginTop: 10}} value={v} onValueChange={this._onVValueChange} />
          </View>
        }
      </View>
    )
